...
# def user2cookie(user, max_age): # 计算cookie值
# 	'''
...
# @asyncio.coroutine
# def cookie2user(cookie_str): #根据cookie值验证身份
# 	'''
...
# 		Blog(id='3', name='Learn More', summary=summary, created_at=time.time()-7200)
# 	]
# 	return {
...
# @post('/api/authenticate') # 验证登陆用户身份后 设置cookie
